...
| "Tharman" | Unknown word | Spelled out letter by letter — no lexicon entry (Tamil name of the former DPM / current President) | `tˈɑːmən` ("TAH-mun"; hard "T", not "th"/θ). **Not ear-verified yet** | `PRONUNCIATION_OVERRIDES` | skillsfuture-at-ten-promise-vs-practice |
| "Shanmugaratnam" | Unknown word | Spelled out letter by letter — no lexicon entry (long Tamil surname) | `ʃˌɑːnmʊɡəɹˈatnəm` ("shahn-moo-guh-RAT-nam", stress on "rat", from Tamil *ratnam*, "jewel"). **Not ear-verified yet** — three samples synthesised | `PRONUNCIATION_OVERRIDES` | skillsfuture-at-ten-promise-vs-practice |
