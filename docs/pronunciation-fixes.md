...
| Pineapple-kings post: the three towkays and old place/person names misaki spells out — "Kah" (Tan Kah Kee), "Tye" (Tan Tye), "Sembawang", "Yishun", "Skudai", "Bastiani" (the Corsican-Italian cannery owner), "Yat-sen", "Kempeitai"/"Kempeitai's" | Unknown word | Spelled out letter by letter | `kˈɑː` / `tˈaɪ` / `sɛmbˈawaŋ` / `jˈiːʃʊn` / `skˈuːdaɪ` / `bˌastiˈɑːni` / `jˌatsˈɛn` / `kˌɛmpeɪtˈaɪ` + `kˌɛmpeɪtˈaɪz`. "Kong"/"Kee"/"Nee"/"Soon"/"Rochor" already covered. Local names (Sembawang, Yishun, Skudai) and Kempeitai marked `# NOT ear-verified yet` pending Chris — samples in `scratch/singapore-canned-pineapple-kings-pronunciation/`. Sembawang / Yishun / Kempeitai recur across many Singapore posts | `PRONUNCIATION_OVERRIDES` | singapore-canned-pineapple-kings |
