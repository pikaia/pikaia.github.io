...
| Linggiu Reservoir post ("Linggiu Reservoir: The Dam Singapore Built Inside Another Country to Secure Its Own Water"): Malay words "Tinggi" (Kota Tinggi) and "Sungai" ("river") confirmed via Wiktionary IPA, names "Muhyiddin"/"Yassin" (Muhyiddin Yassin, then-Johor Mentri Besar) and "Mentri" (Mentri Besar) with no confirmed IPA source found, plain-English compound gap "homegrown" — plus "Linggiu" itself, the post's own repeated subject name, **NOT ear-verified yet** | Unknown word | Spelled out letter by letter | `tˈiŋɡi` ("TING-ghee", Wiktionary /ˈtiŋɡi/) / `sˈuŋaɪ` ("SOO-ngye", Wiktionary /ˈsuŋaj/ — distinct from "Sungei"'s existing `sˈʊŋaɪ` entry above, different spelling/vowel) / `mˌuːhiːjˈɪdɪn` ("moo-hee-YID-in", best-effort) / `jˈɑːsɪn` ("YAH-sin") / `mˈɛntri` ("MEN-tree") / `ˌhQmɡɹˈQn` (built the same way as "outgrown") — "Linggiu" has three candidates (`lˈɪŋɡiu` "LING-ghee-oo", `lˈɪŋɡjuː` "LING-gyoo", `lɪŋɡˈiːu` "ling-GHEE-oo") synthesized to `scratch/linggiu-reservoir-pronunciation/` for Chris to pick by ear, per the process note below — the dict has no entry for it yet | `PRONUNCIATION_OVERRIDES` | linggiu-reservoir-the-dam-singapore-built-inside-another-country-to-secure-its-own-water |
