...
SLIDES = [
    ...
    {"img": "CEM1", "type": "cover", "zoom": [1, 1.09, 1.16], "pan": [(0.35, 0.50), (0.50, 0.50), (0.65, 0.50)], "ease": "ease-out"},
    {"img": "LOCATOR", "type": "cover", "zoom": [1, 1.06, 1.12], "pan": [(0.50, 0.50), (0.48, 0.50), (0.46, 0.50)], "ease": "linear"},
    {"img": "KARAYUKI", "type": "letterbox", "zoom": [1, 1.06, 1.12], "pan": [(0.45, 0.50), (0.50, 0.50), (0.55, 0.50)], "ease": "ease-in-out"},
    {"img": "KARAYUKI", "type": "letterbox", "zoom": [1.12, 1.06, 1], "pan": [(0.55, 0.50), (0.50, 0.50), (0.45, 0.50)], "ease": "ease-in"},
    {"img": "CEM1", "type": "cover", "zoom": [1.16, 1.06, 1], "pan": [(0.65, 0.55), (0.50, 0.50), (0.35, 0.45)], "ease": "ease-in"},
    {"img": "CEM1", "type": "cover", "zoom": [1, 1.1, 1.18], "pan": [(0.50, 0.35), (0.50, 0.50), (0.50, 0.65)], "ease": "ease-out"},
    {"img": "HERO", "type": "cover", "zoom": [1.15, 1.06, 1], "pan": [(0.45, 0.55), (0.50, 0.50), (0.55, 0.45)], "ease": "ease-in"},
    {"img": "KARAYUKI", "type": "letterbox", "zoom": [1, 1.08, 1.15], "pan": [(0.50, 0.50), (0.50, 0.50), (0.50, 0.50)], "ease": "linear"},
    {"img": "PRAYERHALL", "type": "cover", "zoom": [1, 1.08, 1.15], "pan": [(0.50, 0.45), (0.50, 0.50), (0.50, 0.55)], "ease": "ease-in-out"},
    {"img": "OTOKICHI_PORTRAIT", "type": "letterbox", "zoom": [1, 1.06, 1.12], "pan": [(0.50, 0.50), (0.50, 0.50), (0.50, 0.50)], "ease": "linear"},
    {"img": "OTOKICHI_GRAVE", "type": "cover", "zoom": [1, 1.09, 1.16], "pan": [(0.40, 0.50), (0.50, 0.50), (0.60, 0.50)], "ease": "ease-out"},
    {"img": "WARMEM", "type": "cover", "zoom": [1, 1.1, 1.18], "pan": [(0.50, 0.40), (0.50, 0.50), (0.50, 0.60)], "ease": "ease-out"},
    {"img": "WARMEM", "type": "cover", "zoom": [1.18, 1.09, 1], "pan": [(0.60, 0.45), (0.50, 0.50), (0.40, 0.55)], "ease": "ease-in"},
    {"img": "TERAUCHI_PORTRAIT", "type": "letterbox", "zoom": [1, 1.06, 1.12], "pan": [(0.50, 0.50), (0.50, 0.50), (0.50, 0.50)], "ease": "linear"},
    {"img": "CARETAKER", "type": "cover", "zoom": [1, 1.08, 1.15], "pan": [(0.45, 0.50), (0.50, 0.50), (0.55, 0.50)], "ease": "ease-in-out"},
    {"img": "TERAUCHI_GRAVE", "type": "letterbox", "zoom": [1, 1.06, 1.12], "pan": [(0.50, 0.50), (0.50, 0.50), (0.50, 0.50)], "ease": "linear"},
