...
SLIDES = [
    {"img": "HERO", "type": "cover", "zoom": [1, 1.08, 1.15], "pan": [(0.50, 0.40), (0.45, 0.45), (0.40, 0.50)], "ease": "ease-in-out"},
    {"img": "CIRCA1900", "type": "cover", "zoom": [1, 1.09, 1.16], "pan": [(0.45, 0.50), (0.50, 0.50), (0.55, 0.50)], "ease": "ease-out"},
    {"img": "STADHUIS1915", "type": "cover", "zoom": [1.15, 1.06, 1], "pan": [(0.55, 0.45), (0.50, 0.50), (0.45, 0.55)], "ease": "ease-in"},
    {"img": "LOCATOR", "type": "cover", "zoom": [1, 1.06, 1.12], "pan": [(0.50, 0.50), (0.48, 0.50), (0.46, 0.50)], "ease": "linear"},
    {"img": "HERO", "type": "cover", "zoom": [1.15, 1.06, 1], "pan": [(0.55, 0.55), (0.50, 0.50), (0.45, 0.45)], "ease": "ease-out"},
    {"img": "RAFFLES2004", "type": "cover", "zoom": [1, 1.08, 1.15], "pan": [(0.50, 0.35), (0.50, 0.45), (0.50, 0.55)], "ease": "ease-in-out"},
    {"img": "PHOTO1973", "type": "cover", "zoom": [1, 1.09, 1.16], "pan": [(0.40, 0.50), (0.50, 0.50), (0.60, 0.50)], "ease": "linear"},
    {"img": "PHOTO1973", "type": "cover", "zoom": [1.16, 1.06, 1], "pan": [(0.60, 0.45), (0.50, 0.50), (0.40, 0.55)], "ease": "ease-in-out"},
    {"img": "PHOTO1960", "type": "cover", "zoom": [1, 1.1, 1.18], "pan": [(0.45, 0.50), (0.50, 0.45), (0.55, 0.40)], "ease": "ease-out"},
    {"img": "PHOTO1965", "type": "cover", "zoom": [1.15, 1.06, 1], "pan": [(0.55, 0.40), (0.50, 0.50), (0.45, 0.60)], "ease": "ease-in"},
    {"img": "FRONT2014", "type": "cover", "zoom": [1, 1.08, 1.15], "pan": [(0.50, 0.55), (0.50, 0.50), (0.50, 0.40)], "ease": "linear"},
    {"img": "ATRIUM2014", "type": "cover", "zoom": [1, 1.09, 1.16], "pan": [(0.45, 0.45), (0.50, 0.50), (0.55, 0.55)], "ease": "ease-in-out"},
    {"img": "PHOTO2023", "type": "cover", "zoom": [1, 1.1, 1.18], "pan": [(0.50, 0.50), (0.48, 0.45), (0.46, 0.40)], "ease": "ease-out"},
]
