...
last_modified_at: 2026-09-04 04:30:00 +0800
...
<div style="display: flex; gap: 2em; margin: 0.5em 0 1.5em 0; align-items: flex-end;">
  ...
  <a href="https://youtu.be/Fh7IT4cBG_A" target="_blank" rel="noopener" aria-label="Watch this story as a video on YouTube" style="display: inline-flex; flex-direction: column; align-items: center; gap: 0.2em; text-decoration: none; color: inherit;">
  ...
  <a href="https://youtube.com/shorts/tIQnVfHDszg" target="_blank" rel="noopener" aria-label="Watch a short version of this story on YouTube Shorts" style="display: inline-flex; flex-direction: column; align-items: center; gap: 0.2em; text-decoration: none; color: inherit;">
    <span aria-hidden="true" style="display: inline-flex; align-items: center; justify-content: center; width: 2.4em; height: 2.4em; border-radius: 50%; border: 1px solid #888;">
      <svg width="1.4em" height="1.4em" viewBox="0 0 24 24" aria-hidden="true">
        <defs>
          <linearGradient id="shortsGrad3" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stop-color="#FF0000"/>
            <stop offset="100%" stop-color="#FF4E8B"/>
          </linearGradient>
        </defs>
        <rect x="1" y="1" width="22" height="22" rx="7" fill="url(#shortsGrad3)"/>
...
<audio id="listen-audio" preload="none" style="display: none;">
  <source src="/audio/jalan-payoh-lai-kangkar-montfort-nativity-church.mp3" type="audio/mpeg">
</audio>
...
<script>
(function () {
  // Re-cut 2026-09-03: 21 slides folding in nine Chancery Archives
  // photographs + the PD carte-de-visite of Fr Maistre (slide 3). The
  // small frozen photos use zoom [1,1,1] (they don't take enlargement).
  // Kept in sync by value with
  // scripts/video-configs/jalan-payoh-lai-kangkar-montfort-nativity-church.py.
  var slides = [
    { src: "/assets/images/chancery/nativity-aerial.jpg", type: "letterbox", zoom: [1, 1.04, 1.08], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-in-out" },
    ...
    { src: "/assets/images/chancery/nativity-old-marian-statue.jpg", type: "letterbox", zoom: [1, 1.04, 1.08], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-in-out" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/c/c0/Ambroise_Maistre%2C_MEP_missionary_%281821-1866%29.jpg", type: "letterbox", zoom: [1, 1, 1], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "linear" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/f/f5/Church_of_the_Nativity_of_the_Blessed_Virgin_Mary%2C_night%2C_July_2017.jpg", type: "cover", zoom: [1, 1.08, 1.14], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-in-out" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/1/1f/Church_of_the_Nativity_of_the_Blessed_Virgin_Mary_5%2C_Nov_06.JPG", type: "cover", zoom: [1, 1.08, 1.14], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-in-out" },
    { src: "/assets/images/chancery/hies-facade-1910s.jpg", type: "letterbox", zoom: [1, 1.04, 1.08], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-in-out" },
    { src: "/assets/images/chancery/hies-anniversary.jpg", type: "letterbox", zoom: [1, 1.05, 1.1], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-in-out" },
    { src: "/assets/images/chancery/hies-facade-1910s.jpg", type: "letterbox", zoom: [1.08, 1.04, 1], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-out" },
    { src: "/assets/images/chancery/aukang-kampong-houses.jpg", type: "letterbox", zoom: [1, 1.04, 1.08], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-in-out" },
    { src: "/assets/images/chancery/aukang-fisherman.jpg", type: "letterbox", zoom: [1, 1, 1], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "linear" },
    { src: "/assets/images/chancery/aukang-parishioners.jpg", type: "letterbox", zoom: [1, 1.05, 1.1], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-in-out" },
    { src: "/assets/images/chancery/aukang-chng-family-1932.jpg", type: "letterbox", zoom: [1, 1, 1], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "linear" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/3/3e/Punggol_Park%2C_Nov_06.JPG", type: "cover", zoom: [1.06, 1.06, 1.06], pan: ["20% 50%", "50% 50%", "80% 50%"], ease: "ease-in-out" },
    { src: "/assets/images/chancery/aukang-punggol-girls.jpg", type: "letterbox", zoom: [1, 1, 1], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "linear" },
    { src: "/assets/images/chancery/aukang-kampong-houses.jpg", type: "letterbox", zoom: [1.08, 1.04, 1], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-out" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/4/4b/Hougang_HDB_3.JPG", type: "cover", zoom: [1, 1.08, 1.14], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-in-out" },
    { src: "/assets/images/chancery/nativity-aerial.jpg", type: "cover", zoom: [1, 1.08, 1.14], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-in-out" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/9/9c/WorkersPartyHougangSupporters.jpg", type: "cover", zoom: [1.06, 1.06, 1.06], pan: ["20% 50%", "50% 50%", "80% 50%"], ease: "ease-in-out" },
    { src: "https://upload.wikimedia.org/wikipedia/commons/f/f5/Church_of_the_Nativity_of_the_Blessed_Virgin_Mary%2C_night%2C_July_2017.jpg", type: "cover", zoom: [1, 1.08, 1.14], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-in-out" },
    { src: "/assets/images/chancery/nativity-old-marian-statue.jpg", type: "letterbox", zoom: [1, 1.05, 1.1], pan: ["50% 50%", "50% 50%", "50% 50%"], ease: "ease-in-out" }
  ];
  ...
  var sentences = [{"text": "The Lane Was Probably Named After My School.", "offset_s": 0.0, "duration_s": 3.825},{"text": "Neither Is There Anymore.", "offset_s": 3.825, "duration_s": 2.675},{"text": "I was born in 1960 on Jalan Payoh Lai, in what was then the Kangkar area of Hougang.", "offset_s": 6.5, "duration_s": 7.425},{"text": "Memory that old gets slippery, so I can't be certain of every detail, but I remember walking to school and to church there for years afterward.", "offset_s": 13.925, "duration_s": 9.35},{"text": "The walk from the Upper Serangoon Road junction took about twenty minutes.", "offset_s": 23.275, "duration_s": 5.2},{"text": "My favourite shortcut ran along a backlane to the left of Montfort School called Holy Innocents' Lane.", "offset_s": 28.475, "duration_s": 7.275},{"text": "I only learned recently, while researching this post, that the name traces back to a cluster of Catholic schools that once shared that stretch of Upper Serangoon Road.", "offset_s": 35.75, "duration_s": 11.225},{"text": "Montfort was one of them.", "offset_s": 46.975, "duration_s": 2.35},{"text": "Today, neither the lane nor the cemetery that once stood beside it appears on any map.", "offset_s": 49.325, "duration_s": 6.35},{"text": "Sundays meant the same walk in the same direction, except to Mass instead of school.", "offset_s": 55.675, "duration_s": 6.225},{"text": "I'd cut through whatever backlane shaved the most time off the trip.", "offset_s": 61.9, "duration_s": 4.725},{"text": "The church at the end of it, Nativity of the Blessed Virgin Mary, was older than anything else I knew as a child, though I had no idea how much older at the time.", "offset_s": 66.625, "duration_s": 10.8},{"text": "A French missionary priest, Father Ambroise Maistre, bought the land in 1857 for the Teochew Catholic farmers and fishermen of Aukang.", "offset_s": 77.425, "duration_s": 10.3},{"text": "Many of the converts came from Shantou in China.", "offset_s": 87.725, "duration_s": 4.025},{"text": "The original attap chapel eventually gave way to the Neo-Gothic building that still stands today, blessed in December 1901 and expanded again in 1933.", "offset_s": 91.75, "duration_s": 12.425},{"text": "It has been a national monument since 2005.", "offset_s": 104.175, "duration_s": 4.225},{"text": "It still holds a Teochew-language Mass too, a tradition instituted in 1971 that is, as far as anyone can confirm, the last regular Teochew Catholic Mass left in Singapore.", "offset_s": 108.4, "duration_s": 13.975},{"text": "Montfort School, next door, turned out to be part of that same tangle.", "offset_s": 122.375, "duration_s": 5.05},{"text": "It was founded in 1916, not as Montfort but as Holy Innocents' English School, established beside the church by the parish priest of the time.", "offset_s": 127.425, "duration_s": 10.9},{"text": "The Brothers of Saint Gabriel took it over in 1936.", "offset_s": 138.325, "duration_s": 4.725},{"text": "It wasn't the only \"Holy Innocents\" on that stretch of Upper Serangoon Road, though.", "offset_s": 143.05, "duration_s": 5.975},{"text": "Holy Innocents' Boys School grew out of the same church grounds, and so did what's now CHIJ Our Lady of the Nativity.", "offset_s": 149.025, "duration_s": 8.75},{"text": "Holy Innocents' High School traces back further still, to 1892, and remains a separate school today.", "offset_s": 157.775, "duration_s": 7.85},{"text": "The names collided so often that in 1958 Holy Innocents' English School was renamed Montfort, after Saint Louis Marie Grignion de Montfort, the order's founder, specifically to end the confusion.", "offset_s": 165.625, "duration_s": 14.275},{"text": "I can't say for certain which of those schools Holy Innocents' Lane was actually named for.", "offset_s": 179.9, "duration_s": 6.1},{"text": "Montfort, my own school, was simply one of at least three that could have claimed it.", "offset_s": 186.0, "duration_s": 5.275},{"text": "Montfort itself moved to Hougang Avenue 8 in 1992.", "offset_s": 191.275, "duration_s": 5.4},{"text": "At some point after that, the lane and the cemetery next to it were cleared away entirely.", "offset_s": 196.675, "duration_s": 6.15},{"text": "\"Hougang\" is the Mandarin reading of the Hokkien and Teochew \"Au Kang,\" meaning the end of the river.", "offset_s": 202.825, "duration_s": 6.45},{"text": "Kangkar itself meant \"foot of the stream.\"", "offset_s": 209.275, "duration_s": 3.4},{"text": "That's where the settlements clustered, wherever Teochew planters ran their kangchu system of jungle-clearing plantations along Sungei Serangoon.", "offset_s": 212.675, "duration_s": 10.2},{"text": "There were roughly twenty such kangkars across the island by an 1849 newspaper count.", "offset_s": 222.875, "duration_s": 6.825},{"text": "By 1986, more than nine in ten Kangkar villagers were still Teochew, and the dialect was still the area's everyday language.", "offset_s": 229.7, "duration_s": 9.5},{"text": "The Kangkar I half-remember was cleared in 1984.", "offset_s": 239.2, "duration_s": 4.85},{"text": "Its families were resettled into three- and four-room HDB flats, and its land was folded into what's now Punggol Park.", "offset_s": 244.05, "duration_s": 9.1},{"text": "Punggol End, further along, was a different kind of village entirely: Kampong Wak Sumang, a Malay fishing settlement at Tanjong Punggol.", "offset_s": 253.15, "duration_s": 9.75},{"text": "By one descendant's account it was founded before 1819.", "offset_s": 262.9, "duration_s": 5.2},{"text": "It only got piped water, electricity and proper roads in the 1960s, and it became briefly well known afterward for its seafood restaurants and boatels.", "offset_s": 268.1, "duration_s": 11.425},{"text": "The government announced reclamation in 1983 and told residents to vacate by 1986.", "offset_s": 279.525, "duration_s": 7.75},{"text": "The fishing port and wholesale market outlasted the kampong itself, but even that finally closed in 1997, to make way for Punggol New Town.", "offset_s": 287.275, "duration_s": 11.0},{"text": "Hougang New Town itself was announced in 1979, planned for 460 hectares and 120,000 residents.", "offset_s": 298.275, "duration_s": 10.125},{"text": "Its first neighbourhoods were finished by 1983, and the rest by 1992, the same year Montfort left its original site for good.", "offset_s": 308.4, "duration_s": 9.825},{"text": "One thing about the area never got redeveloped along with everything else.", "offset_s": 318.225, "duration_s": 5.65},{"text": "Hougang has been held by the same opposition party, the Workers' Party, in every general election since 1991.", "offset_s": 323.875, "duration_s": 8.975},{"text": "It's a small, quietly remarkable fact in its own right, less a story about any one politician than a marker of how far Singapore's electoral landscape has matured since the kampong days.", "offset_s": 332.85, "duration_s": 13.55},{"text": "I can't reconstruct the Kangkar of my childhood in any real detail anymore.", "offset_s": 346.4, "duration_s": 5.7},{"text": "The specific smells, the sounds, the neighbours' faces are mostly gone, the same way the lane and the cemetery are gone.", "offset_s": 352.1, "duration_s": 8.3},{"text": "What's left is the walk itself: twenty minutes each way, a shortcut past a school that used to have a different name, to a church that has outlasted every version of the neighbourhood around it.", "offset_s": 360.4, "duration_s": 12.325},{"text": "Why it matters today: Most of what made up the Hougang I grew up in — the lane, the cemetery, the kampong itself — exists now only in scattered memories like mine, and in records like the ones that let me write this.", "offset_s": 372.725, "duration_s": 14.225},{"text": "Montfort School and Nativity Church are the rare fixed points that survived the clearing.", "offset_s": 386.95, "duration_s": 6.1},{"text": "That's probably the only reason I can still find my way back to any of it at all.", "offset_s": 393.05, "duration_s": 5.825}];
  ...
  var imageSchedule = [
    { t: 0.0, slide: 0 },  // aerial - title + born 1960 + the twenty-minute walk
    { t: 28.475, slide: 1 },  // route-walk - shortcut past Montfort down Holy Innocents' Lane; lane + cemetery gone
    { t: 55.675, slide: 2 },  // old Marian statue - Sunday walk to Mass; the old church
    { t: 77.425, slide: 3 },  // Maistre portrait - Fr Maistre buys the land 1857; converts from Shantou
    { t: 91.75, slide: 4 },  // church at night - attap chapel -> Neo-Gothic church, blessed 1901, monument since 2005
    { t: 108.4, slide: 5 },  // church interior - the Teochew-language Mass; Montfort next door
    { t: 127.425, slide: 6 },  // HIES facade - founded 1916 as Holy Innocents' English School; Brothers of Saint Gabriel 1936
    { t: 149.025, slide: 7 },  // HIES anniversary group - the tangle of "Holy Innocents" schools (Boys, CHIJ, HI High to 1892)
    { t: 165.625, slide: 8 },  // HIES facade (reprise) - renamed Montfort 1958; which school the lane was named for
    { t: 191.275, slide: 9 },  // Aukang kampong houses - Montfort moves to Hougang Ave 8 1992; lane + cemetery cleared; "Au Kang" / "foot of the stream"
    { t: 212.675, slide: 10 },  // Aukang fisherman - Teochew planters and the kangchu plantations along Sungei Serangoon
    { t: 222.875, slide: 11 },  // Aukang parishioners - roughly twenty kangkars by an 1849 count; the parish community
    { t: 229.7, slide: 12 },  // Chng family 1932 - by 1986 more than nine in ten Kangkar villagers still Teochew
    { t: 239.2, slide: 13 },  // Punggol Park - the 1980s Kangkar cleared 1984, folded into Punggol Park
    { t: 253.15, slide: 14 },  // Punggol girls - Punggol End and Kampong Wak Sumang; located by road and milestone
    { t: 279.525, slide: 15 },  // Aukang kampong houses (reprise) - reclamation 1983; fishing port to 1997; Punggol New Town
    { t: 298.275, slide: 16 },  // Hougang HDB - Hougang New Town announced 1979, built out by 1992 - the year Montfort left
    { t: 318.225, slide: 17 },  // aerial (reprise) - one thing about the area never got redeveloped; WP since 1991
    { t: 332.85, slide: 18 },  // WP supporters - a matured electoral landscape
    { t: 346.4, slide: 19 },  // church at night (reprise) - the Kangkar of childhood can't be reconstructed; the walk, the church
    { t: 372.725, slide: 20 }  // old Marian statue (reprise) - why it matters; Montfort and Nativity the rare fixed points
  ];
  var TOTAL_DURATION = 398.875;
...
**Why it matters today:** Most of what made up the Hougang I grew up in — the lane, the cemetery, the kampong itself — exists now only in scattered memories like mine, and in records like the ones that let me write this. Montfort School and Nativity Church are the rare fixed points that survived the clearing. That's probably the only reason I can still find my way back to any of it at all.

---

**Sources:**
- [Kangkar — Teochews in Singapore](https://teochewsinsingapore.wordpress.com/tag/kangkar/)
- [Hougang — Singapore Infopedia, National Library Board](https://eresources.nlb.gov.sg/infopedia/articles/SIP_2016-08-11_160158.html)
- [Kampong Wak Sumang, Punggol — BiblioAsia, National Library Board](https://biblioasia.nlb.gov.sg/all-sections/vol-19-issue-2-jul-sep-2023-kampong-wak-sumang-punggol/)
- [History of Punggol — Roots.gov.sg](https://www.roots.gov.sg/han/Neighborhoods/Punggol/HAN-Resources-Folder/History-of-Punggol)
- [Montfort Secondary School — Wikipedia](https://en.wikipedia.org/wiki/Montfort_Secondary_School)
